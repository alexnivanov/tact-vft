...
function dictValueParserSetVoteData(): DictionaryValue<SetVoteData> {
 ...
 type VftVoteContract_init_args = {
    $$type: 'VftVoteContract_init_args';
    statement: Address;
    idx: bigint;
}

function initVftVoteContract_init_args(src: VftVoteContract_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeAddress(src.statement);
        b_0.storeInt(src.idx, 257);
    };
}

async function VftVoteContract_init(statement: Address, idx: bigint) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initVftVoteContract_init_args({ $$type: 'VftVoteContract_init_args', statement, idx })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const VftVoteContract_errors: { [key: number]: { message: string } } = {
...
const VftVoteContract_types: ABIType[] = [
...
const VftVoteContract_getters: ABIGetter[] = [
    {"name":"balance","arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

const VftVoteContract_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"SetVoteData"}},
...
export class VftVoteContract implements Contract {
    
    static async init(statement: Address, idx: bigint) {
        return await VftVoteContract_init(statement, idx);
    }
    
    static async fromInit(statement: Address, idx: bigint) {
        const init = await VftVoteContract_init(statement, idx);
        const address = contractAddress(0, init);
        return new VftVoteContract(address, init);
    }
    
    static fromAddress(address: Address) {
        return new VftVoteContract(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  VftVoteContract_types,
        getters: VftVoteContract_getters,
        receivers: VftVoteContract_receivers,
        errors: VftVoteContract_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: SetVoteData | null | 'withdraw all' | 'withdraw safe' | Withdraw) {
        
        let body: Cell | null = null;
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'SetVoteData') {
            body = beginCell().store(storeSetVoteData(message)).endCell();
        }
        if (message === null) {
            body = new Cell();
        }
