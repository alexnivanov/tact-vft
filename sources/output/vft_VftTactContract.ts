...
function dictValueParserAdd(): DictionaryValue<Add> {
 ...
 type VftTactContract_init_args = {
    $$type: 'VftTactContract_init_args';
    owner: Address;
}

function initVftTactContract_init_args(src: VftTactContract_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
...
async function VftTactContract_init(owner: Address) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initVftTactContract_init_args({ $$type: 'VftTactContract_init_args', owner })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const VftTactContract_errors: { [key: number]: { message: string } } = {
...
const VftTactContract_types: ABIType[] = [
...
const VftTactContract_getters: ABIGetter[] = [
    {"name":"counter","arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
]

const VftTactContract_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"Add"}},
    {"receiver":"internal","message":{"kind":"text","text":"increment"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Deploy"}},
]

export class VftTactContract implements Contract {
    
    static async init(owner: Address) {
        return await VftTactContract_init(owner);
    }
    
    static async fromInit(owner: Address) {
        const init = await VftTactContract_init(owner);
        const address = contractAddress(0, init);
        return new VftTactContract(address, init);
    }
    
    static fromAddress(address: Address) {
        return new VftTactContract(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  VftTactContract_types,
        getters: VftTactContract_getters,
        receivers: VftTactContract_receivers,
        errors: VftTactContract_errors,
    };
